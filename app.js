const REDIRECT_URI = window.location.origin + window.location.pathname;
        ...
        async function subscribeToEvents(sessionId) {
            ...
            if (targetBroadcasterId === loggedInUserId) {
                ...
                // フォロー・サブスクも自分自身のアクセス権(moderator/channel scope)が必要
                types.push({ type: 'channel.follow', version: '2', condition: { broadcaster_user_id: targetBroadcasterId, moderator_user_id: targetBroadcasterId } });
